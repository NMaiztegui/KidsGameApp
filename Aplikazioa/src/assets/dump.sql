...
INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (1, "Dolores herri honen historia eta garrantzia oso ondo ezagutzen dituen andre bat da. Politikari espainiarra izan zelako da ezaguna batez ere, baina hori alde batera utzita ondo ezagutzen zuen La Arboledako eta inguruko meatzaritzaren historia osoa. Izan ere, bere familia eta bere senarra herri honetako meategietan lan egiten zuten.
Gogoratu! meatzaritza lana Trapagarango elementu garrantzitsuenetako bat  zela, eta bere senarra garai hartako meatzari ezaguna zenez, Doloresek asko ikasi ahal izan zuen lanbideari buruz. Meategietako langileen eskubideak defendatzera ere iritsi zen, oso lan-baldintza txarretan lan egiten baitzuten.", "Aspaldian, Trapagaran misteriotsuan, meatzari ausartak mendietan sartzen ziren altxor ezkutuak ateratzeko; hain zuzen, herriari bizia ematen zioten mineral distiratsuak.", "/assets/img/mapa1.png", 1);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (2, "Aspaldian, Bizkaiko meategietan, meatzariek altzairuzko barrenak erabiltzen zituzten. Barrenak makila oso luzeak ziren. Harkaitzetan zuloak egin, lehergailuak jarri eta horrela harriak puskatzeko erabiltzen zituzten. Pertsona horiei harrizulatzaile deitzen zitzaien. 
...
INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (3, "Ba al dakizue greba bat zer den? Pertsona talde batek lan egiteari uztea eta protesta egitea  erabakitzen duenean da, beren lanean zerbait bidezkoa ez denean.
1890eko greba oso garrantzitsua izan zen Bizkaiko meatzeetako langileentzat. Maiatzaren 1ean, Langileen Nazioarteko Eguna, parte hartzeagatik La Orconera enpresako 5 meatzari kaleratu zituzten. Nagusiak berriz kontratatzeari uko egin zionean, gainerako meatzariek bat egin zuten, 500 grebalari izatetik 8000 izatera igaroz.
Meategi eta lantegietan zehar ibili ziren hobekuntzak eskatuz. Loma izeneko jeneral bat negoziatzera bidali zuten eta, meatzarien baldintza gogorrak ikusi ondoren, grebalariei lagundu zien. Horrela jaio zen Loma Ituna, bere bizitzak hobetu zituena.", "Handik ez oso urrun, Gallartan, meatzariek lehia zirraragarria ospatzen zuten: altzairuzko barra izugarriekin zuloak egiten zituzten harkaitzetan! Nork azkarrago egiten zuen ikustea benetako ikuskizuna zen.", "/assets/img/mapa3.png", 3);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (4, "Espainiako meatzaritzaren museorik zaharrena Gallartan  dago, eta meatzari ohiek sortu zuten haien bizimodua, meatzaritza, inoiz ahaztu ez zedin.
...
Gainera, museo honek hainbat jarduera eskaintzen ditu, zeuek parte hartzeko eta meatzaritzaren esperientzia bizitzeko aukera izan dezazuen. Horrela, meatzariek eurek erabilitako babes-kaskoak  eta Kontxa IIn erabilitako tontorrak  zuen eskuekin hartu ahal izango dituzue. Zatozte museoa ezagutzera!", "Makinak iritsi eta beren lekua hartu bazuten ere, tradizio horren emozioak bizirik dirau.", "/assets/img/mapa4.png", 4);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (5, "1926an funikularra izeneko  garraiobide berezi bat inauguratu zen, aldapa handiak igo eta jaisteko balio duena. Funikular horrek   Zugaztieta eta Trapagaran  lotzen zituen. Existitu baino lehen, jendeak ordu eta erdi behar izaten zuen ibilbide hori egiteko, baina funikularrarekin 10 minutu baino ez ziren behar!
Gainera, meatzarientzat oso garrantzitsua izan zen, bizitza errazagoa egiten zielako. Pertsonak ez ezik, mineralak eta ibilgailuak ere garraiatzen zituen, eta horrek asko lagundu zien bere lanean, eta inguruko guztien bizitza hobetu zuen.", "1890ean, meatzariek euren unerik zailenetako bat bizi izan zuten. Greba handi bat hasi zen lankide batzuk bidegabeki kaleratu zituztenean. Baina ez zuten amore eman, eta azkenean, haien bizitzak hobetu zituen akordio bat irabazi zuten, Loma Ituna bezala ezaguna.", "/assets/img//mapa5.png", 5);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (6, "Zugaztieta ez da jada meatzaritza gune bat eta aisialdirako leku bihurtu da, baina oraindik ere baditu iragana gogorarazten diguten elementuak, hala nola  lurraren kolore gorrixkak, eskulturak eta bagoneta zaharrak.
Aspaldi, erromatarren garaitik, bazekiten Zugaztietan mineralak zeudela, baina Industria Iraultzan (makina berri asko asmatzen hasi ziren garaian), XIX. mendearen amaieran, askoz gehiago ateratzen hasi ziren. Urteak igaro ahala, meategiak ixten joan ziren, eta 1993an ez zen bat ere zabalik geratu.
Meatzeak itxi zituztenean, lur azpiko urak zulo horiek bete zituen eta  lakuak sortu ziren, Ostion aintzira bezala.", "Gainera, funikularra, asmakizun harrigarria, agertu zen. Garraio magiko horrek Trapagarango jendea Zugaztietara eramaten zuen minutu gutxitan, bizitza askoz errazagoa eginez.", "/assets/img/mapa6.png", 6);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (7, "Zugaztietako meategietan lan egiten zuten antzinako langileek babarrun asko jaten zituzten, baina babarrunak ez ziren gaur egun bezain ospetsuak. Orain, Zugaztietako plan edo ospakizun ohikoenetako bat lagunekin edo familiarekin babarrunak jatera joatea da, tabernak eta jatetxeak jendez beteta egoten dira babarrunen eraginez. 
...
Zuek noizbait joan zarete Zugaztietako babarrunak  jatera? Probatu ez badituzue, animatzen zaituztegu egitera. Errepikatzeko gogoekin geratuko zarete eta, sinets iezaiguzue!", "Gaur egun, meategiak itxita badaude ere, Zugaztieta leku berezia da oraindik. Aintzinako putzuak laku eder bihurtu ziren, eta familiak herrian hain gustuko dituzten babarrun gozoak jatera joaten dira.", "/assets/img/mapa/mapa7.png", 7);

INSERT OR IGNORE INTO erronkas (id, azalpena, testu_izkutua, mapa_irudia, testu_izkutua_id) VALUES (8, "Oso ondo egin duzue! Tamalez, bidaia honen amaierara iristen ari gara, eta ahalik eta ondoen amaitzeko, letra-zopa bat egitea proposatzen dizuegu.", NULL, "/assets/img/mapa8.png", 8);
